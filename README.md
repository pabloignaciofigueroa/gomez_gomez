...
- `guia-marca.html`: guía actualizada con azul cobalto #0047AB protagonista.
...
## Cambios principales
Navbar cobalto sólido; vídeo de Huicha en portada; presentación de Jorge y mensaje de hogar fusionados en segunda posición; otros proyectos sobre grafito; secuencia de tres vídeos sobre el oficio; transformación de Nercón; contacto cobalto. Huicha no se repite como tarjeta en el portafolio.
